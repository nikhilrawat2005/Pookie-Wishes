  ...
  try { 
    ...
    if (template === 'ninja-game') {
      return { 
        ...
        senderName: sender, 
        message: message,
        scroll1: pData.scroll1 || pData.scroll_1,
        scroll2: pData.scroll2 || pData.scroll_2,
        scroll3: pData.scroll3 || pData.scroll_3,
        scroll4: pData.scroll4 || pData.scroll_4
      };
    }
    if (template === 'wedding') {
      return { 
